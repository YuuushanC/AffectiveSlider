...
CREATE TABLE IF NOT EXISTS dataset_sessions (
  ...
  source_video_size_bytes BIGINT UNSIGNED NOT NULL,
  ...
  target_construct VARCHAR(64) NOT NULL,
  browser_family VARCHAR(32),
  browser_major_version VARCHAR(16),
